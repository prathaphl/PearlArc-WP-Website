...
// ------ Footer Settings ------ //
// ----------------------------- //
$footer_background_position = neuros_get_prepared_option('footer_background_position', '', 'footer_customize');
$footer_background_repeat   = neuros_get_prepared_option('footer_background_repeat', '', 'footer_customize');
$footer_background_size     = neuros_get_prepared_option('footer_background_size', '', 'footer_customize');
$footer_background_image    = neuros_get_prepared_img_url('footer_background_image', 'footer_customize');
